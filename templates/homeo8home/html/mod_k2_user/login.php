...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2LoginBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login" class="col-xs-12 col-md-5 col-sm-8 col-sm-offset-2 well hh_registration_form">
		<?php if($params->get('pretext')): ?>
		<p class="preText"><?php echo $params->get('pretext'); ?></p>
	  <?php endif; ?>
	<legend>Login to homeo8home</legend>
	  <fieldset class="input">
	    ...
	    <p id="form-login-remember">
	      <label for="modlgn_remember" class="rrr"><?php echo JText::_('K2_REMEMBER_ME') ?></label>
	      <input id="modlgn_remember"class="" type="checkbox" name="remember" class="inputbox" value="yes" />
	    </p>
	    <?php endif; ?>
		<div class="clr"></div>
	    <input type="submit" name="Submit" class="button login_submit_button" value="<?php echo JText::_('K2_LOGIN') ?>" />
	  </fieldset>

	  <ul class="login_list text-center">
